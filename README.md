...
- Off-white light theme (fork customisation)
- ...
...
- Off-white background / light-only appearance
- Small security hardening: external links are opened directly via the shell instead of `cmd /c start`
- Included `SECURITY_REVIEW.md` with a quick source audit
- Wi-Fi / Ethernet priority controls with reset-to-automatic
